 ...
 */
class Version20140520202916 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE achimfritz_championship_domain_model_registrationrequest ADD email VARCHAR(255) NOT NULL, ADD username VARCHAR(255) NOT NULL");
	}
	...
	public function down(Schema $schema) {
		...
		$this->addSql("CREATE TABLE achimfritz_championship_domain_model_accountrequest (persistence_object_identifier VARCHAR(40) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, hmac VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, creationdate DATETIME NOT NULL, status INT NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		...
		$this->addSql("ALTER TABLE achimfritz_championship_domain_model_registrationrequest DROP email, DROP username");
