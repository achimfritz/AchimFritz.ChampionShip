 ...
 */
class Version20131007175237 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE achimfritz_championship_domain_model_ranking (persistence_object_identifier VARCHAR(40) NOT NULL, cup VARCHAR(40) DEFAULT NULL, user VARCHAR(40) DEFAULT NULL, points INT NOT NULL, INDEX IDX_22037EB79D50E4 (cup), INDEX IDX_22037E8D93D649 (user), PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
	...
	public function down(Schema $schema) {
		...
		$this->addSql("CREATE TABLE achimfritz_championship_domain_model_points (persistence_object_identifier VARCHAR(40) NOT NULL, user VARCHAR(40) DEFAULT NULL, cup VARCHAR(40) DEFAULT NULL, points INT NOT NULL, INDEX IDX_D8E7EBBCB79D50E4 (cup), INDEX IDX_D8E7EBBC8D93D649 (user), PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
