 ...
 */
class GroupRoundCalculatorService {
	 ...
	 */
	public function updateGroup(\AchimFritz\ChampionShip\Domain\Model\GroupRound $groupRound) {
	 ...
	 * @return \AchimFritz\ChampionShip\Domain\Model\GroupRound $groupRound
	 */
	protected function updateGroupTable(\AchimFritz\ChampionShip\Domain\Model\GroupRound $groupRound) {
	 ...
	 * @return \AchimFritz\ChampionShip\Domain\Model\GroupRound $groupRound
	 */
	protected function updateMatches(\AchimFritz\ChampionShip\Domain\Model\GroupRound $groupRound) {
		$teams = $groupRound->getTeams();
